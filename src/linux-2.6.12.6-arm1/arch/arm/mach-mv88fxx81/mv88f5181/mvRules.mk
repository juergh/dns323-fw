...
QD_DIR             = $(BOARD_DIR)/QDDriver/qddrv/

BOARD_TEMPERSENSOR_DIR      = $(BOARD_DIR)/TemperSensor
#Vincent02272006
BOARD_FANSPEEDCTL_DIR      = $(BOARD_DIR)/FanSpeed
#Vincent03212006
...
BOARD_PATH      = -I$(SRC_PATH_I)/$(BOARD_DIR) -I$(SRC_PATH_I)/$(BOARD_ENV_DIR) \
		  ...
		  -I$(SRC_PATH_I)/$(SATA_CORE_DIR) -I$(SRC_PATH_I)/$(BOARD_SLIC_DIR) -I$(SRC_PATH_I)/$(BOARD_TDM_DIR) -I$(SRC_PATH_I)/$(BOARD_TEMPERSENSOR_DIR) -I$(SRC_PATH_I)/$(BOARD_FANSPEEDCTL_DIR)
#Vincent02272006 add -I$(SRC_PATH_I)/$(BOARD_TEMPERSENSOR_DIR)
#Vincent03212006 add -I$(SRC_PATH_I)/$(BOARD_FANSPEEDCTL_DIR)
