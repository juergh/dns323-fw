 ...
 * Revision history:
 * $Log: sx.c,v $
 * Revision 1.1.1.1  2009/08/19 08:02:08  jack
 * no message
 *
 * Revision 1.1.1.1  2008/07/31 08:08:54  ffna
 * no message
 *
 * Revision 1.1.1.1  2006/11/21 06:23:27  jack
 * no message
 *
...
#define RCS_ID "$Id: sx.c,v 1.1.1.1 2009/08/19 08:02:08 jack Exp $"
